...
#model_file="cifar10-resnet18-kernel-np4-pr0.5-lcm0.0001.pt" # this doesnt need full path, io utils handle it
model_file="esc-EscFusion-kernel-np4-pr0.5-lcm10.pt" # this doesnt need full path, io utils handle it

log_dir_name='test_folder' # saves logging messages to ./logs/[log_dir_name] 
