...
model_file="cifar100-resnet101-kernel-np4-pr0.5-lcm1e-05.pt" # this doesnt need full path, io utils handle it
#model_file="esc-EscFusion-kernel-np4-pr0.5-lcm10.pt" # this doesnt need full path, io utils handle it

log_dir_name='.\local_logs\cifar100-resnet101-kernel-np4-pr0.5-lcm1e-05-batch16' # saves logging messages to ./logs/[log_dir_name] 
